...
if __name__=='__main__':
    ...
    print('停用词读取完毕，共{n}个单词，读入数据中...'.format(n=len(stop_words)))
    ...
    print('文本中总共有{n1}个单词，不重复单词数{n2}，选取前30000个单词进入词典，开始训练...'
